...
public interface IProductRepository extends JpaRepository<Product, Integer> {
    ...
    @Query(value = "select * from product join product_type pt on pt.id = product.product_type_id join suppliers s on s.id = product.suppliers_id where product.id =:id", nativeQuery = true)
    Product Detail(@Param("id") Integer id);
